---
title: "0007. Unified wallet port and pluggable IdentityHub adapter"
description: "Unified wallet.Wallet port decoupling domain logic from Fafnir and IdentityHub adapters."
---
